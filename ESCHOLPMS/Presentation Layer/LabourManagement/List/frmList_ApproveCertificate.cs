...
namespace ESCHOLPMS
{
    public partial class frmList_ApproveCertificate : Form
    {
        Labour lab = new Labour();

        public frmList_ApproveCertificate()
        {
            InitializeComponent();
        }
        ...
        private void gridLabours_CellDoubleClick(object sender, Syncfusion.WinForms.DataGrid.Events.CellClickEventArgs e)
        {
            ...
            if (rowIndex != -1)
            {
                ...
                frmApproveCertificate nl = new frmApproveCertificate(selectedLabour);
                nl.ShowDialog();
                LoadLabours();
