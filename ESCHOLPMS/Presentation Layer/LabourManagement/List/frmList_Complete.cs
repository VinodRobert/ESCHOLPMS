...
namespace ESCHOLPMS
{
    public partial class frmList_Complete : Form
    {
        Labour lab = new Labour();
        int indexCode;
        public frmList_Complete()
        {
            InitializeComponent();
        }
        ...
        private void gridLabours_CellDoubleClick(object sender, Syncfusion.WinForms.DataGrid.Events.CellClickEventArgs e)
        {
            ...
            if (rowIndex != -1)
            {
                ...
                frmSingleLabourDetails sl = new frmSingleLabourDetails(selectedLabour);
                sl.ShowDialog();
                LoadLabours(indexCode);
        ...
        private void btnActive_Click(object sender, EventArgs e)
        {
            indexCode = 1;
            LoadLabours(1);
            lblHeader.Text = "Complete List of Active Labours";
        }
        ...
        private void btnInactive_Click(object sender, EventArgs e)
        {
            indexCode = 2;
            LoadLabours(2);
            lblHeader.Text = "Complete List of In Active Labours";
        }

        private void btnTerminated_Click(object sender, EventArgs e)
        {
            indexCode = 3;
            LoadLabours(3);
            lblHeader.Text = "Complete List of Terminated Labours ";
        }
    }
}
