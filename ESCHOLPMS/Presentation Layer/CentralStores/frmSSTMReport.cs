...
namespace ESCHOLPMS 
{
    public partial class frmSSTMReport : Form
    {
        public TransferReports tp = new TransferReports();
        public frmSSTMReport()
        {
            InitializeComponent();
        }
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            //gridReport.TableDescriptor.Columns[10].HeaderText = "Accepted Qty";
            ...
            gridReport.TableDescriptor.Columns[10].HeaderText = "Prepared By";
            gridReport.TableDescriptor.Columns[10].Width = 200;
            gridReport.TableDescriptor.Columns[10].AllowGroupByColumn = false;
            gridReport.TableDescriptor.Columns[10].AllowFilter = true;

            gridReport.TableDescriptor.Columns[11].HeaderText = "Accepted By";
            ...
            gridReport.TableDescriptor.Columns[12].HeaderText = "Status";
            gridReport.TableDescriptor.Columns[12].Width = 155;
