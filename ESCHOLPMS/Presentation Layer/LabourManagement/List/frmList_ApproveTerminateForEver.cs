...
namespace ESCHOLPMS
{
    public partial class frmList_ApproveTerminateForEver : Form
    {
        Labour lab = new Labour();

        public frmList_ApproveTerminateForEver()
        {
            InitializeComponent();
        }
        ...
        private void LoadLabours()
        {
            ...
            DataSet dslabours = lab.FetchTerminatedForEverLabours();
        ...
        private void gridLabours_CellDoubleClick(object sender, Syncfusion.WinForms.DataGrid.Events.CellClickEventArgs e)
        {
            ...
            if (rowIndex != -1)
            {
                ...
                frmApproveTerminateForEver nl = new frmApproveTerminateForEver(selectedLabour);
                nl.ShowDialog();
                LoadLabours();
