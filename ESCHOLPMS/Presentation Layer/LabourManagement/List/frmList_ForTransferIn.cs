...
namespace ESCHOLPMS
{
    public partial class frmList_ForTransferIn : Form
    {
        Labour lab = new Labour();

        public frmList_ForTransferIn()
        {
            InitializeComponent();
        }
        ...
        private void LoadLabours()
        {
            ...
            DataSet dslabours = lab.FetchTransferredIn(costCentreID);
        ...
        private void gridLabours_CellDoubleClick(object sender, Syncfusion.WinForms.DataGrid.Events.CellClickEventArgs e)
        {
            ...
            if (rowIndex != -1)
            {
                ...
                frmTransferIn nl = new frmTransferIn(selectedLabour);
                nl.ShowDialog();
                LoadLabours();
