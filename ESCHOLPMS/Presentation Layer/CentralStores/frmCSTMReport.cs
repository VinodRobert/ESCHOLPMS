...
namespace ESCHOLPMS 
{
    public partial class frmCSTMReport : Form
    {
        public TransferReports tp = new TransferReports();
        public frmCSTMReport()
        {
            InitializeComponent();
        }
        ...
        private void LoadDetail(DataTable _dt)
        {
            ...
            gridReport.TableDescriptor.Columns[2].Width = 150;
            ...
            gridReport.TableDescriptor.Columns[9].HeaderText = "Prepared By";
            gridReport.TableDescriptor.Columns[9].Width = 200;
            gridReport.TableDescriptor.Columns[9].AllowGroupByColumn = false;
            gridReport.TableDescriptor.Columns[9].AllowFilter = true;

            gridReport.TableDescriptor.Columns[10].HeaderText = "Accepted By";
            gridReport.TableDescriptor.Columns[10].Width = 200;
            gridReport.TableDescriptor.Columns[10].AllowFilter = true;
            gridReport.TableDescriptor.Columns[10].AllowGroupByColumn = false;

            gridReport.TableDescriptor.Columns[11].HeaderText = "Status";
            gridReport.TableDescriptor.Columns[11].Width = 155;
